...
STATIC_URL = '/static/' # amended from 'static/'
# Add the static directory to the list of directories where Django will look for static files
STATICFILES_DIRS = [
...
# Use the console backend for email during development.
